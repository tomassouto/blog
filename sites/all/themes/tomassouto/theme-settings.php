...
function tomassouto_form_system_theme_settings_alter(&$form, &$form_state) {

  $form['#attached']['library'][] = 'tomassouto/theme-settings';
  ...
  $form['mtt_settings']['basic_tab']['basic_settings']['breadcrumb_separator'] = array(
    ...
    '#default_value' => theme_get_setting('breadcrumb_separator', 'tomassouto'),
    '#size'          => 20,
    '#maxlength'     => 100,
  );
  ...
  $form['mtt_settings']['basic_tab']['basic_settings']['scrolltop']['scroll_to_top_display'] = array(
    ...
    '#default_value' => theme_get_setting('scroll_to_top_display', 'tomassouto'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['basic_tab']['basic_settings']['scrolltop']['scroll_to_top_icon'] = array(
    ...
    '#default_value' => theme_get_setting('scroll_to_top_icon','tomassouto'),
    '#size'          => 20,
    '#maxlength'     => 100,
  );
  ...
  $form['mtt_settings']['bootstrap_tab']['bootstrap']['bootstrap_remote_type'] = array(
    ...
    '#description'   => t('From the drop down select box, select how to load the Bootstrap library. If you select "Local" make sure that you download and place Bootstrap folder into the root theme folder (tomassouto/bootstrap).'),
    '#default_value' => theme_get_setting('bootstrap_remote_type', 'tomassouto'),
    '#options' => array(
  ...
  '#type' => 'item',
   ...
   <img src="' . base_path() . drupal_get_path('theme', 'tomassouto') . '/images/premium-01-looknfeel.jpg" />
   </a></div> ',
  );
  ...
  '#type' => 'item',
   ...
   <div class="theme-settings-image-wrapper">
   <a href="http://morethanthemes.com/themes/restaurantplus" target="_blank">
   <img src="' . base_path() . drupal_get_path('theme', 'tomassouto') . '/images/premium-02-region.jpg" />
   </a></div> ',
  );
  ...
  '#type' => 'item',
   ...
   <div class="theme-settings-image-wrapper">
   <a href="http://morethanthemes.com/themes/restaurantplus" target="_blank">
   <img src="' . base_path() . drupal_get_path('theme', 'tomassouto') . '/images/premium-03-article.jpg" />
   </a></div> ',
  );
  ...
  '#type' => 'item',
   ...
   <div class="theme-settings-image-wrapper">
   <a href="http://morethanthemes.com/themes/restaurantplus" target="_blank">
   <img src="' . base_path() . drupal_get_path('theme', 'tomassouto') . '/images/premium-04-layout.jpg" />
   </a></div> ',
  );
  ...
  '#type' => 'item',
   ...
   <div class="theme-settings-image-wrapper">
   <a href="http://morethanthemes.com/themes/restaurantplus" target="_blank">
   <img src="' . base_path() . drupal_get_path('theme', 'tomassouto') . '/images/premium-05-fonts.jpg" />
   </a></div> ',
  );
 ...
 $form['mtt_settings']['slideshows_tab']['slideshow']['premium-description'] = array(
  '#type' => 'item',
   ...
   <div class="theme-settings-image-wrapper">
   <a href="http://morethanthemes.com/themes/restaurantplus" target="_blank">
   <img src="' . base_path() . drupal_get_path('theme', 'tomassouto') . '/images/premium-06-slideshow.jpg" />
   </a></div> ',
  );
 ...
 $form['mtt_settings']['isotope_tab']['isotope']['premium-description'] = array(
  '#type' => 'item',
   ...
   <div class="theme-settings-image-wrapper">
   <a href="http://morethanthemes.com/themes/restaurantplus" target="_blank">
   <img src="' . base_path() . drupal_get_path('theme', 'tomassouto') . '/images/premium-07-isotope.jpg" />
   </a></div> ',
  );
  ...
  $form['mtt_settings']['google_maps_tab']['google_maps_key'] = array(
   ...
   <div class="theme-settings-image-wrapper">
   <a href="http://morethanthemes.com/themes/restaurantplus" target="_blank">
   <img src="' . base_path() . drupal_get_path('theme', 'tomassouto') . '/images/premium-09-googlemaps.jpg" />
   </a></div> ',
  );
